...
VALUES (1, 'Ivan', 'Ivanov', '2022-09-01'),
       (2, 'Petro', 'Petrenko', '2021-09-01'),
       (3, 'Maria', 'Shevchenko', '2023-09-01');
GO

INSERT INTO Courses (CourseID, CourseName, CourseDescription, Credits)
VALUES (1, 'Mathematics', 'Advanced Mathematics Course', 4),
       (2, 'History', 'World History Course', 3),
       (3, 'Computer Science', 'Intro to Programming', 5);
GO
